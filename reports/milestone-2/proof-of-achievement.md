...
| 5   | Docker Compose local setup                | [`docker-compose.yml`](https://github.com/ItsDaveB/OgmiosDotnet.BlockchainEvents/blob/main/docker-compose.yml) (15 services), [`docker-compose.debug.yml`](https://github.com/ItsDaveB/OgmiosDotnet.BlockchainEvents/blob/main/docker-compose.debug.yml) — see [demo video](#demo-video) below                                                                                                                                                                |
