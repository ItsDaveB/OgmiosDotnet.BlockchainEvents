...
**Date:** June 2026  
**Commit:** `30cdf46` (cursor/milestone-3-ui-consumer-ef3a)
...
| 2   | Video demo showing live updates + filter type results    | [Demo Video](#demo-video), covering metadata, governance/treasury, and address match filters                                                                                                                                                                                                                                                                                                                                                                                |
...
> 1. Run `docker compose up --build` and show all services starting
> 2. Open http://localhost:4020 and show connection status and Connection Log panel
> 3. Wait for 10+ events and show Time, Rule, Metadata columns populating
> 4. Switch to Metadata filter and show distinct events and rule chips
> 5. Switch to Governance filter and show governance vote events
> 6. Open http://localhost:4021 and http://localhost:4022 side by side to show pre-configured filters
> 7. Click an event row and show detail drawer with full CloudEvent payload
